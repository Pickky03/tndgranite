...
import { graniteStoneData, demo } from '@/app/data/graniteStone';

export default function GraniteStone() {   
    const [selectedProduct, setSelectedProduct] = useState(null);

    const products = graniteStoneData;
    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <h1 className="text-3xl font-bold text-center mb-8 text-black-600">DÒNG ĐÁ TỰ NHIÊN GRANITE
            </h1>
