...
import { luxData, demo } from '@/app/data/luxData';

export default function Lux() {   
    const [selectedProduct, setSelectedProduct] = useState(null);

    const products = luxData;
    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <h1 className="text-3xl font-bold text-center mb-8 text-black-600">DÒNG ĐÁ THẠCH ANH LUX QUARTZ
            </h1>
