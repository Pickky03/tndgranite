...
import { marbleStoneData, demo } from '@/app/data/marbleStoneData';    

export default function MarbleStone() {   
    const [selectedProduct, setSelectedProduct] = useState(null);

    const products = marbleStoneData;
    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <h1 className="text-3xl font-bold text-center mb-8 text-black-600">DÒNG ĐÁ TỰ NHIÊN MARBLE
            </h1>
