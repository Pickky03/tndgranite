...
import { terrazzoStoneData, demo } from '@/app/data/terrazzoStoneData';

export default function TerrazzoStone() {   
    const [selectedProduct, setSelectedProduct] = useState(null);

    const products = terrazzoStoneData;
    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <h1 className="text-3xl font-bold text-center mb-8 text-black-600">DÒNG ĐÁ NHÂN TẠO TERRAZZO
            </h1>
